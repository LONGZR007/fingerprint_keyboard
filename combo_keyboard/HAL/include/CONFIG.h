...
#endif
#ifndef BLE_SNV_ADDR
#define BLE_SNV_ADDR                        0x77C00-FLASH_ROM_MAX_SIZE  /* 1KB SNV 区: 0x7C00~0x7FFF */
#endif
#ifndef BLE_SNV_BLOCK
#define BLE_SNV_BLOCK                       256
#endif
#ifndef BLE_SNV_NUM
#define BLE_SNV_NUM                         4   /* 电脑 + 手机 bond 并存 (原值 1 只能存 1 条, 手机 bond 保存失败) */
#endif
#ifndef CLK_OSC32K
#define CLK_OSC32K                          1   // 该项请勿在此修改，必须在工程配置里的预处理中修改，如包含主机角色必须使用外部32K
#endif
#ifndef BLE_MEMHEAP_SIZE
#define BLE_MEMHEAP_SIZE                    (1024*7)  /* 官方多连接例程(MultiCentPeri)同款配置, 双连接所需 */
#endif
...
#define PERIPHERAL_MAX_CONNECTION           2   /* 双连接: 电脑(HID) + 手机(距离监测) */
#endif

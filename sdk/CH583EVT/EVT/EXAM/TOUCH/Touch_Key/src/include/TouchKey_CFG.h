...
#define TKY_CHS_INIT\
    ...
    GEN_TKY_CH_INIT(TKY_QUEUE_1,10,2,3,0,3393,74,59),\
    GEN_TKY_CH_INIT(TKY_QUEUE_2,9,2,3,0,3311,82,66),\
    GEN_TKY_CH_INIT(TKY_QUEUE_3,8,2,3,0,3300,71,56),\
    GEN_TKY_CH_INIT(TKY_QUEUE_4,7,2,3,0,3264,81,65),\
    GEN_TKY_CH_INIT(TKY_QUEUE_5,6,2,3,0,3331,77,61),\
    GEN_TKY_CH_INIT(TKY_QUEUE_6,5,2,3,0,3278,74,59)
        /* Add new above this */

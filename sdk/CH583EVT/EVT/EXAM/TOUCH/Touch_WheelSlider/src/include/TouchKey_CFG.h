...
#define TKY_CHS_INIT \
        GEN_TKY_CH_INIT( TKY_QUEUE_0,  5, 2, 3, 0, 3621, 30, 20 ),\
        GEN_TKY_CH_INIT( TKY_QUEUE_1,  6, 2, 3, 0, 3600, 30, 20 ),\
        GEN_TKY_CH_INIT( TKY_QUEUE_2,  8, 1, 3, 0, 3360, 30, 20 ),\
        GEN_TKY_CH_INIT( TKY_QUEUE_3,  1, 2, 3, 0, 3233, 30, 20 ),\
        GEN_TKY_CH_INIT( TKY_QUEUE_4,  9, 2, 3, 0, 3604, 30, 20 ),\
        GEN_TKY_CH_INIT( TKY_QUEUE_5, 10, 2, 3, 0, 3214, 30, 20 ),\
